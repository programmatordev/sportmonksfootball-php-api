...
class Team
{
    ...
    public function __construct(array $data, string $timezone)
    {
        ...
        $this->activeSeasons = isset($data['activeseasons']) ? EntityHelper::createEntityCollection(Season::class, $data['activeseasons'], $timezone) : null;
        $this->venue = isset($data['venue']) ? new Venue($data['venue'], $timezone) : null;
        $this->rivals = isset($data['rivals']) ? EntityHelper::createEntityCollection(Team::class, $data['rivals'], $timezone) : null;
        $this->players = isset($data['players']) ? EntityHelper::createEntityCollection(TeamSquad::class, $data['players'], $timezone) : null;
        $this->sidelined = isset($data['sidelined']) ? EntityHelper::createEntityCollection(Sidelined::class, $data['sidelined'], $timezone) : null;
        $this->sidelinedHistory = isset($data['sidelinedhistory']) ? EntityHelper::createEntityCollection(Sidelined::class, $data['sidelinedhistory'], $timezone) : null;
        ...
        $this->socials = isset($data['socials']) ? EntityHelper::createEntityCollection(Social::class, $data['socials']) : null;
        $this->coaches = isset($data['coaches']) ? EntityHelper::createEntityCollection(TeamCoach::class, $data['coaches'], $timezone) : null;
        $this->statistics = isset($data['statistics']) ? EntityHelper::createEntityCollection(TeamStatistic::class, $data['statistics'], $timezone) : null;
        $this->rankings = isset($data['rankings']) ? EntityHelper::createEntityCollection(Ranking::class, $data['rankings']) : null;
    }
